...
const ProductListPage = () => {
  ...
  return (
    <div style={{ background: '#FAF8F4', minHeight: '100vh' }}>
      {/* Header */}
      <div style={{ background: '#0A1628', padding: '60px 32px 40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ fontSize: '11px', color: '#C9962A', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '10px' }}>
            NU Merchandise
          </div>
          <h1 style={{ fontFamily: 'Playfair Display, serif', fontWeight: 800, fontSize: '42px', color: 'white', margin: 0, lineHeight: 1.1 }}>
            Shop All Products
          </h1>
      ...
      {/* Category Filter */}
      <div style={{ background: 'white', borderBottom: '1px solid #E8E2D9', padding: '0 32px' }}>
          ...
          {categories.map(cat => (
            <button
              ...
              style={{
                ...
                color: activeCategory === cat ? '#C9962A' : 'rgba(10,22,40,0.5)',
                borderBottom: activeCategory === cat ? '2px solid #C9962A' : '2px solid transparent',
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '48px 32px' }}>
        {filtered.length === 0 ? (
          <p style={{ textAlign: 'center', color: 'rgba(10,22,40,0.4)', padding: '80px 0' }}>No products found.</p>
        ) : (
          <div style={{
            display: 'grid',
